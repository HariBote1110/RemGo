...
if os.environ.get('REMGO_ENABLE_LEGACY_FOOOCUS_LAUNCHER') != '1':
    print('[DEPRECATED] entry_with_update.py is deprecated and disabled by default.')
...
raise RuntimeError('Legacy updater/launcher is no longer maintained in this repository.')
